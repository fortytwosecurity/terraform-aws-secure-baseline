...
data "aws_iam_policy_document" "audit_log" {
  ...
  source_policy_documents   = [local.flow_logs_use_s3 ? data.aws_iam_policy_document.audit_log_flow_logs[0].json : data.aws_iam_policy_document.audit_log_config[0].json]
